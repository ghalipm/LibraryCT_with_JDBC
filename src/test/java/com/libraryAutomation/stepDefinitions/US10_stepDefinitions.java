...
public class US10_stepDefinitions {
    ...
    public void the_user_should_see_the_following_column_names(List<String> expectedColumnNames) {
        ...
        //option2:
        List<String> actualColumnNamesUI = BrowserUtils.getElementsText(usersPage.tableHeaders);
        Assert.assertEquals(actualColumnNamesUI, expectedColumnNames);
        System.out.println("actualColumnNames = " + actualColumnNamesUI);
